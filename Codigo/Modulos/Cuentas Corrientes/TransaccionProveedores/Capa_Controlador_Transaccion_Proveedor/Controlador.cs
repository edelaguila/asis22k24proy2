...
namespace Capa_Controlador_Transaccion_Proveedor
{
    public class Controlador
    {
        Capa_Modelo_Transaccion_Proveedor.Sentencias sentencias = new Capa_Modelo_Transaccion_Proveedor.Sentencias();
