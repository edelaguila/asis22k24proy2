...
CREATE TABLE Tbl_TrasladoProductos (
    ...
    destino VARCHAR(100) NOT NULL,  -- Nuevo campo para el destino
    ...
    Fk_id_vehiculo INT NOT NULL,  -- Nueva columna para la relación con Tbl_vehiculos
    ...
    FOREIGN KEY (Fk_id_vehiculo) REFERENCES Tbl_vehiculos(Pk_id_vehiculo) -- Relación con Tbl_vehiculos
);
