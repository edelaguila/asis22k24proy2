...
{
    public class Sentencia_Ordenes
    {
        private readonly Conexion_Produccion conexion;
        ...
        // Cambia `private` a `internal` o `public`
        ...
        // Método para insertar el encabezado de la orden, con manejo de excepciones mejorado
        ...
        // Método para insertar productos relacionados en detalle de orden
        ...
        {
            // Implementa un sistema de logs aquí. Podrías guardar en un archivo de texto o usar un servicio de logs.
