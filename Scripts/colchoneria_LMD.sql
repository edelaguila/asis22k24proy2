...
INSERT INTO `Tbl_vendedor` (nombre_vendedor, direccion_vendedor, telefono_vendedor, departamento_vendedor, estado)
VALUES
...
INSERT INTO `Tbl_clientes` (Fk_id_vendedor, nombre_cliente, telefono_cliente, direccion_cliente, saldo_cuenta, estado)
VALUES
(1, 'Carlos Ruiz', 23456789, 'Calle 10', 500, 1),  -- Habilitado
(1, 'Lucía Martínez', 34567890, 'Calle 20', 0, 0);  -- Inhabilitado

-- Insertar datos en Tbl_cobrador
INSERT INTO `Tbl_cobrador` (nombre_cobrador, direccion_cobrador, telefono_cobrador, depto_cobrador, estado)
VALUES
('Jorge López', 'Calle 5', 45678901, 'Cobranzas', 1),
('Ana Fernández', 'Calle 15', 56789014, 'Cobranzas', 0);

-- Insertar datos en Tbl_paises
INSERT INTO `Tbl_paises` (nombre_pais, region_pais, estado)
VALUES
...
INSERT INTO `Tbl_tipodepago` (nombre_pago, tipo_moneda, estado)
VALUES
('Efectivo', 'USD', '1'),
...
fecha_vencimiento_deuda, descripcion_deuda, estado)
VALUES
...
Fk_id_deuda, monto_deuda, monto_transaccion, saldo_pendiente, Fk_id_pago, tipo_moneda, serie_transaccion, estado)
VALUES
...
INSERT INTO `Tbl_proveedores` (fecha_registro, nombre_proveedor, direccion, telefono, email, saldo_cuenta, estado)
VALUES
