...
namespace Capa_Controlador_Produccion
{
    ...
    {
        private readonly Capa_Modelo_Produccion.Sentencias_Lotes sentencias;

        // Constructor que inicializa la instancia de Sentencias_Lotes para interactuar con la base de datos
        public Control_Lotes()
        {
            sentencias = new Capa_Modelo_Produccion.Sentencias_Lotes();
        }
