...
namespace CapaControlador_AndresVeron
{
    public class Controlador
    {
        ...
        public List<string> ListadoClientesActivos()
        {
            return sn.ObtenerClientesActivos();
        }
        public List<string> FormaFactura()
        {
            return sn.ObtenerFactura();
        }

        public List<string> ListadoEfecto()
        {
            return sn.ObtenerEfecto();
        }
    }
