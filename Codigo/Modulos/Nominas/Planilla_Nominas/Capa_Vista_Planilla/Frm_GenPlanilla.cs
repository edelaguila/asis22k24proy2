...
namespace Capa_Vista_Planilla
{
    public partial class Frm_GenPlanilla : Form
    {
        ...
        private void proCargarEncabezado(string mesTexto)
        {


            //// Cargar deducciones en la DataGridView
            DataTable encabezado = cn.funObtenerEncabezado(mesTexto);
        ...
        private void cbo_mes_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            LlenarDataGridView(mesSeleccionado);


        }
        public void LlenarDataGridView(string mesTexto)
        {
            try
            {
