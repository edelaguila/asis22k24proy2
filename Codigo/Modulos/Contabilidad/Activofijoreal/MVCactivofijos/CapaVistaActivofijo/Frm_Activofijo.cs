...
namespace CapaVistaActivofijo
{
    ...
    public partial class Frm_Activofijo : Form
    {
        ...
        public Frm_Activofijo()
        {
            ...
            // Configura el texto de cada tooltip
            toolTip1.SetToolTip(Btn_Nuevo, "Abre el formulario de depreciación.");
            toolTip2.SetToolTip(Btn_Editar, "Actualiza los datos en la tabla.");
            toolTip3.SetToolTip(Btn_imprimir, "Genera el reporte de mantenimiento del activo.");
            toolTip4.SetToolTip(Btn_depreci, "Genera el reporte de la depreciación.");
        }
        ...
        public ReporteMantenimiento FormReporteMantenimiento;
        public async void Btn_imprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Crear una nueva instancia del formulario de reporte de mantenimiento
                FormReporteMantenimiento = new ReporteMantenimiento();

                // Establecer la posición de inicio del formulario
                FormReporteMantenimiento.StartPosition = FormStartPosition.CenterScreen;

                // Mostrar el formulario
                FormReporteMantenimiento.Show();

                // Confirmar que el formulario se abrió
                MessageBox.Show("Formulario de mantenimiento abierto");
            }
            catch (Exception ex)
            {
                // Mostrar un mensaje de error en caso de excepción
                MessageBox.Show($"Ocurrió un error al abrir el formulario de mantenimiento: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
