...
namespace Capa_Modelo_Implosion_Explosion
{
    public class Sentencia_Implosion_Explocion
    {
        private Conexion_Implosion_Explocion conexion = new Conexion_Implosion_Explocion();
